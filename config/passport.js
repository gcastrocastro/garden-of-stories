...
// to plug-in an instance of the OAuth strategy and provide a verify callback function that will be called whenever a user has logged in using OAuth
...
// to provide a callback that Passport will call after the verify callback.
passport.serializeUser(function(user, cb) {
    cb(null, user._id);
  });

//to provide a callback that Passport will call for every request when a user is logged in.
